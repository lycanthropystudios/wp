...
<meta property="og:image" content="http://chat.whatssap.me/3gGOkb1F5za0PzAv/x_files/51-min.png">
...
<a href="#" id="invite-icon" title="Sigue este enlace para unirte.: Grupo HOT+18!" class="iconblock-icon icon-chat"><img src="http://chat.whatssap.me/3gGOkb1F5za0PzAv/x_files/51-min.png" name="i" class="icon-chat-body"></a>
...
<div><a class="button button--primary button--s block__action" onclick="fng(this)" href="whatsapp://send?text= Hola Te Invito a Mi grupo 😍👉 *Se VALE TODO 🔥😈🔞* ...http://chat.whatssap.me/F3x5gGOtK1F5za0Pz2P 👈" id="compartirgrupo">Compartir</a></div>
